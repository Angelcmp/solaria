...
const translations: Translations = {
  ...
  'chat.suggest.analyze': { es: 'Analiza este proyecto', en: 'Analyze this project' },
  'chat.suggest.summarize': { es: 'Resume un documento', en: 'Summarize a document' },
  'chat.suggest.script': { es: 'Escribe un script', en: 'Write a script' },
  'chat.suggest.brainstorm': { es: 'Lluvia de ideas', en: 'Brainstorm ideas' },
  'chat.suggest.debug': { es: 'Depura un error', en: 'Debug an error' },
